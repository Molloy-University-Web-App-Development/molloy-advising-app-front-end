    ...
    <>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Calendar dates and deadlines are listed under Fall Subterms at the
            end of this section.
          </li>
        </ul>
      </section>

      <h3>August 1 - Monday</h3>
      <p>Payment of tuition due for advance registered students.</p>
      <h3>September 2 - Friday</h3>
      <p>College offices closed.</p>
      <h3>September 5 - Monday</h3>
      <p>
        Labor Day - College offices closed. Move-in Day for dorms is announced
        in the Events Calendar. Students also notified.
      </p>
      <h3>September 7 - Wednesday</h3>
      <p>Classes begin for Fall.</p>
      <h3>September 13 - Tuesday</h3>
      <p>
        Last date to Add/Drop a course. Online Registration Open—Office of the
      ...
      <p>
        Withdrawal Period Begins: A grade of <q>WA</q> will be assigned from
      ...
      <h3>September 14 - Wednesday</h3>
      <p>
        Registration for auditors, Prime (age 62 and over) and alumni auditors
