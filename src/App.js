...
import Logo from "./Images/Molloy.jpg";
// import Foo from "./Foo";
          ...
          <Route
            ...
            element={
              <>
                ...
                <img id="logo" src={Logo} alt="molloy logo" />
                <p class="main">
                  Check out what you need for the minor requirements :)
                </p>
                <>
                  <h1 class="main">Computer Science Minor</h1>
                  <p class="main">
                  ...
                  <ul>
                    ...
                    <li class="courses">
                      <Link to="DataStructures">CSC 2440</Link> | Data
                      Structures | 4
                    </li>
                  </ul>
